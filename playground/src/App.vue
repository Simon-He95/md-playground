...
<template>
  <div p5>
    ...
    <svg ma class="cursor-pointer group" xmlns="http://www.w3.org/2000/svg" width="24"
      height="24" viewBox="0 0 24 24" @click="copy(transfer(md)!)">
      <path fill="#adbf88" class="group-hover:fill-green"
